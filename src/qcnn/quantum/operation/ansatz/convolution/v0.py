...
from qcnn.quantum.operation import Shift
from qcnn.quantum.operation.ansatz import Ansatz
from qcnn.quantum.operation.ansatz.basic import BasicFiltering
from qcnn.quantum.operation.ansatz.simple import SimpleFiltering

if TYPE_CHECKING:
    from typing import Iterable
    from numbers import Number
    from qcnn.quantum.operation import Unitary, Parameters, Qubits
